...
<section class="content-header">
  <h1>
    Eventos
    <small>Cadastrar um novo evento</small>
  </h1>
  <ol class="breadcrumb">
...
<section class="content">
  ...
  @endif
    <div class="box box-danger">
      ...
      <div class="box-body">
        <form method="post" action="{{action('BackendController@storeEventoUsuario')}}" enctype="multipart/form-data">
          {!! csrf_field() !!}
        ...
        <div class="form-group">
          ...
          <div class="radio">
            <label>
              <input type="radio" name="ativo" id="optionsRadios1" value="N" checked readonly>
                Pendente de Aprovação pela administração
              </label>
          </div>
        </div>
        <div class="form-group">
      ...
      <div class="box-footer">
        ...
        <a href="{{ action('BackendController@eventosCriado') }}" class="btn btn-danger pull-right">Cancelar</a>
      </form>
      </div>
    </div>
</section><!-- /.content -->
